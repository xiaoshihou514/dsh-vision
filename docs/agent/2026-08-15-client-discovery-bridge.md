...
Harness scans enabled root Loader entries for `package.json#dsh.client`. It does not resolve client declarations from subpath entries such as `dsh-vision/vision-tool` or `dsh-vision/vision-upload`.
