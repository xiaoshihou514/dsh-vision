...
function PaperclipIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M5.55 9.75V5h1.4v4.75a1.05 1.05 0 0 0 2.1 0V4.5a2.8 2.8 0 0 0-5.6 0v5.25a4.55 4.55 0 0 0 9.1 0V4h1.4v5.75a5.95 5.95 0 0 1-11.9 0V4.5a4.2 4.2 0 0 1 8.4 0v5.25a2.45 2.45 0 0 1-4.9 0Z" fill="currentColor" />
    </svg>
  )
}
...
function LoadingIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M13.13 13.13a7.25 7.25 0 1 1 0-10.26l-.99.99a5.85 5.85 0 1 0 0 8.28Z" fill="currentColor">
    ...
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
      ...
      {error !== null ? (
        <span
          ...
          aria-label={error}
          title={error}
          style={{ display: 'grid', placeItems: 'center', color: 'var(--dsw-alias-label-error)', cursor: 'help' }}
        >
          <svg width="14" height="14" viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 1.25a6.75 6.75 0 1 0 0 13.5A6.75 6.75 0 0 0 8 1.25Zm-.75 3h1.5v5h-1.5v-5Zm0 6.25h1.5V12h-1.5v-1.5Z" fill="currentColor" />
          </svg>
        </span>
      ) : null}
      <input
