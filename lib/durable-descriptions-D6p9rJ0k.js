...
function descriptionCacheKey(attachmentId, model, promptVersion) {
...
var DurableVisionDescriptionStore = class extends VisionDescriptionStore {
	...
	async resolve(request, signal) {
		...
		const key = descriptionCacheKey(String(request.image.ref.attachmentId), this.backend.model, this.backend.promptVersion);
...
//#endregion
export { name as a, inject as i, apply as n, VisionDescriptionStore as o, descriptionCacheKey as r, isVisionMessageSource as s, DurableVisionDescriptionStore as t };
